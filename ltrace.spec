...
Patch100: 0001-Initialize-libsym-early-in-trace.c-to-help-the-compi.patch
...
%changelog
* Mon Aug 5 2019 DJ Delorie <dj@redhat.com> - 0.7.91-1
...
- Reset to -1 for devtoolset-7 (#1464226)

* Tue Mar  7 2017 DJ Delorie <dj@redhat.com> - 0.7.91-13
- Remove mentions of (and one attempt to patch) backup files in 
  ltrace-0.7.91-unwind-elfutils.patch (#1427140)

* Fri Jul 17 2015 DJ Delorie <dj@redhat.com> - 0.7.91-12
- Pull in fc23 patches

* Fri Mar  6 2015 Petr Machata <pmachata@redhat.com> - 0.7.91-11
...
* Wed Jan  7 2015 Petr Machata <pmachata@redhat.com> - 0.7.91-10
- Bump to rebuild.
